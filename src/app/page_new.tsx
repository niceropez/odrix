          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Conecta tu cuenta de Strava y obtén insights detallados sobre
                tus entrenamientos, progreso y rendimiento deportivo.
              </p>
            ...
            <div id="features" className="mt-20">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="text-center p-6 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Analiza tus tiempos, distancias y mejoras a lo largo del
                    tiempo
                  </p>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="text-gray-600 mb-6">
            Tu cuenta de Strava está conectada correctamente. Ahora puedes
            acceder a tus datos.
          </p>
